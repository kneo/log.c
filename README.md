...
First call to initialize the logging, basically sets the internal structure to "0", and defaults.
...
#### log_set_localtime(log_LocalTimeFn fn)

If you use a time provider different from the standard library, use this interface to override this function. Default is the "localtime" function of "time.h".
